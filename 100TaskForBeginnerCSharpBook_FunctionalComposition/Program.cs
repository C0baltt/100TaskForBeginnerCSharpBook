...
namespace _100TaskForBeginnerCSharpBook_FunctionalComposition
{
    class Program
    {
        ...
        private static void ExecuteCommand(string command)
        {
            ...
            {
                //Разбиение строки на еденицы данных
                ...
                //Проверка корректности этих данных на основе текущей модели.
                if (!Exist(id))
                {
